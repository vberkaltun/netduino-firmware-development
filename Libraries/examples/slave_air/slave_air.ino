...
#define DEVICE_BRAND "Mitsubishi Electric"
#define DEVICE_MODEL "MSZ-LN Legendera"
#define DEVICE_VERSION "MSZ"
...
#define WIRE_BEGIN 0x45

#define PIN_FAN_GROUND 9
#define PIN_FAN_ENABLE 10
#define PIN_FAN_ODD 11
#define PIN_FAN_EVEN 12
...
void setup() {
  ...
  // Initialize fan device pin
  pinMode(PIN_FAN_GROUND, OUTPUT);
  pinMode(PIN_FAN_ENABLE, OUTPUT);
  pinMode(PIN_FAN_ODD, OUTPUT);
  pinMode(PIN_FAN_EVEN, OUTPUT);

  // Set initial rotation direction
  digitalWrite(PIN_FAN_GROUND, LOW);
  digitalWrite(PIN_FAN_ODD, LOW);
  digitalWrite(PIN_FAN_EVEN, HIGH);
}
...
void setSpeed(unsigned short sizeofData, char data[]) {
  ...
  analogWrite(PIN_FAN_ENABLE, 255 * atoi(data) / 100);
  digitalWrite(PIN_FAN_ODD, LOW);
  digitalWrite(PIN_FAN_EVEN, HIGH);
}
